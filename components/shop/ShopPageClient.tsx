...
function filterShopProducts(f: ShopUrlFilters): ShopProduct[] {
...
function brandsToRecord(brands: string[]): Record<string, boolean> {
...
export function ShopPageClient({
  ...
  const brandState = useMemo(() => brandsToRecord(filters.brands), [filters]);

  const filtered = useMemo(() => filterShopProducts(filters), [filters]);
